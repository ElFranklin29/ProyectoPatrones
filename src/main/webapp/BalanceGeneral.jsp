    ...
    <body>
        ...
        <div class="centered-div d-flex justify-content-center">
            <div class="d-flex gap-3">
                <h4>Estado de ánimo: <%=encuestaDiariaVO.getEstadoAnimo()%></h4>
                <h4>Nivel de energía: <%=encuestaDiariaVO.getNivelEnergia()%></h4>
                <h4>Estrés/ansiedad: <%=encuestaDiariaVO.getEstresAnsiedad()%></h4>
            </div>
        </div>
